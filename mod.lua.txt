...
-- 
-- v6.9 (2026-08-04)
-- 🔧 重写核心循环：修复所有开关“有UI无效果”的问题。
-- ⚡ 物理驱动增强：飞行、飞车、传送、甩飞等直接绑定 AssemblyLinearVelocity。
-- 🔒 去冗余化：移除了多余的 pcall 兜底，保证循环不被断。
--
-- =====================================================================
...
local titleText = Instance.new("TextLabel"); titleText.Parent = titleBar; titleText.Size = UDim2.new(0.6, 0, 1, 0); titleText.Position = UDim2.new(0.05, 0, 0, 0); titleText.BackgroundTransparency = 1; titleText.Font = Enum.Font.GothamBold; titleText.Text = " 小木HUB v6.9"; titleText.TextColor3 = Color3.fromRGB(80, 160, 255); titleText.TextSize = 16; titleText.TextXAlignment = Enum.TextXAlignment.Left
...
print("✅【小木HUB v6.9】功能已完全激活！点击左侧⚡按钮打开界面。")
