...
-- =====================================================================
-- 修复下拉弹窗作用域瑕疵
-- 修复游戏强制覆盖 WalkSpeed/JumpPower 问题
-- =====================================================================
...
local function setupChar(char)
    ...
    if currentWindow and currentWindow.main then
        currentWindow.main.Visible = false
    end
...
function UI:CreateDropdown(groupObj, title, items, onSelect)
    ...
    frame.MouseButton1Click:Connect(function()
        ...
        -- 🔥 修复1：将 connection 提升到外层，使其在 closeBtn 和外部点击中都可见
        local connection
...
-- 【构建界面】
-- ==========================================
local window = UI:CreateWindow("小木HUB v7.12")
...
renderConnection = RunService.RenderStepped:Connect(function()
    ...
    if Misc.Noclip and character then
        pcall(function()
